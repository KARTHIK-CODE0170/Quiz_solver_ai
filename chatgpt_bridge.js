...
(async function () {
    ...
    async function handleTask(task) {
        ...
        // Find the visible prompt textarea (in existing chats there might be hidden ones)
        let inputEl = null;
        for (let i = 0; i < 50; i++) {
            const els = document.querySelectorAll('#prompt-textarea, textarea[data-id="root"], div[contenteditable="true"]#prompt-textarea');
            // get the last one (the one at the bottom of the chat)
        ...
        if (inputEl.tagName.toLowerCase() === 'textarea') {
            ...
            // For contenteditable, dispatching paste usually reliably triggers React
            inputEl.innerHTML = '';
            ...
            // Fallback if paste didn't populate DOM
        ...
        // Force React to recognize the input by typing a space at the end
